      ...
      <AboutContainer>
        ...
        <AboutWrapper>
          <About>
            <FadeUp>
              <p>
                <IntroHighlight>Here is my story. </IntroHighlight>My journey
                into coding started with curiosity and grew into a love for
                solving problems and creating impactful solutions. Whether
                designing responsive frontends or building scalable backends, I
